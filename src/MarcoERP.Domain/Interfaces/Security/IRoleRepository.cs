...
namespace MarcoERP.Domain.Interfaces.Security
{
    ...
    {
        /// <summary>Gets a role by ID with all permissions loaded.</summary>
        ...
        /// <summary>Checks if a role name already exists.</summary>
        Task<bool> NameExistsAsync(string nameEn, int? excludeId = null, CancellationToken ct = default);
    }
}

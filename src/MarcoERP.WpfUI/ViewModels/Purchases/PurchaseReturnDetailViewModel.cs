    ...
    public sealed class PurchaseReturnDetailViewModel : BaseViewModel, INavigationAware, IInvoiceLineFormHost, IDirtyStateAware
    {
        ...
        private async Task SaveAsync()
        {
            ...
            try
            {
                ...
                if (IsNew)
                {
                    var dto = new CreatePurchaseReturnDto { ReturnDate = FormDate, SupplierId = FormSupplierId ?? 0, WarehouseId = FormWarehouseId ?? 0, OriginalInvoiceId = FormOriginalInvoiceId, Notes = FormNotes?.Trim(), Lines = lines };
                ...
                {
                    var dto = new UpdatePurchaseReturnDto { Id = CurrentReturn.Id, ReturnDate = FormDate, SupplierId = FormSupplierId ?? 0, WarehouseId = FormWarehouseId ?? 0, OriginalInvoiceId = FormOriginalInvoiceId, Notes = FormNotes?.Trim(), Lines = lines };
        ...
        {
            FormNumber = ret.ReturnNumber; FormDate = ret.ReturnDate; FormSupplierId = ret.SupplierId;
